...
- [2. 理解矩阵与矩阵乘法](#understand-matrix-and-matrix-multiplication)
	...
	- [2.2. 矩阵乘法的几何意义](#geometric-meaning-of-matrix-multiplication)
		- [2.2.1. 基的变换](#base-transformation)
			- [2.2.1.1. 矩阵映射法则——基的变换](#mapping-method-base-transformation)
			- [2.2.1.2. 基变换的一个实例——旋转矩阵](#example-of-base-transformation-orientation-matrix)
